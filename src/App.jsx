...
function Button({ children, variant='primary', href='#download', className='' }) {
  ...
  return <a href={href} className={`inline-flex items-center justify-center gap-2 rounded-xl px-5 py-3.5 text-sm font-semibold transition duration-300 ${styles} ${className}`}>{children}</a>
}
